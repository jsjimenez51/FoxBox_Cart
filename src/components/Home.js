    ...
    render(){
        ...
        let itemList = this.props.items.map(item=>{
            ...
            return(
                ...
                <Card className={classes.card}>
                    ...
                    <CardHeader className={classes.header} classes={{title: classes.title}}
                    title={item.name}
                    />
                    <CardMedia
                    ...
                    <CardContent>
                        <Typography paragraph><b>Item Description:</b></Typography>
        ...
        return(
            ...
            <div container className={classes.container}>
                <Typography className={classes.conTitle} variant="h5" align="center" gutterBottom>Available Items</Typography>
                <Grid container className={classes.box} spacing={16}>
                    <Grid item xs={12}>
                        <Grid container className={classes.foods} justify="center" spacing={16}>
                            {itemList}
                        </Grid>
